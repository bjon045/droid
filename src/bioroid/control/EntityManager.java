...
public final class EntityManager {
	...
	if (startMenuPanel == null) {
	    ...
	    startMenuPanel = new StartMenuPanel(mainPanelLocation.getX(), mainPanelLocation.getY(), getBackgroundPanel().getMainWidth(), getBackgroundPanel()
		    .getMainHeight());
	}
	...
	if (mapPanel == null) {
	    Location mainPanelLocation = getBackgroundPanel().getMainStart();
	    mapPanel = new MapPanel(mainPanelLocation.getX(), mainPanelLocation.getY(), getBackgroundPanel().getMapWidth(), getBackgroundPanel().getMapHeight());
	}
	return mapPanel;
    }
	...
	if (characterPanel == null) {
	    characterPanel = new CharacterPanel(Display.getWidth() - Constants.CHAR_PANEL_WIDTH, 0, Constants.CHAR_PANEL_WIDTH, Display.getHeight());
	}
	...
	if (partyGenerationPanel == null) {
	    Location mainPanelLocation = getBackgroundPanel().getMainStart();
	    partyGenerationPanel = new PartyGenerationPanel(mainPanelLocation.getX(), mainPanelLocation.getY(), getBackgroundPanel().getMainWidth(),
		    getBackgroundPanel().getMainHeight());
	}
	...
	if (raceSelectionPanel == null) {
	    Location mainPanelLocation = getBackgroundPanel().getMainStart();
	    raceSelectionPanel = new RaceSelectionPanel(mainPanelLocation.getX(), mainPanelLocation.getY(), getBackgroundPanel().getMainWidth(),
		    getBackgroundPanel().getMainHeight());
	}
	...
	if (skillSelectionPanel == null) {
	    Location mainPanelLocation = getBackgroundPanel().getMainStart();
	    skillSelectionPanel = new SkillSelectionPanel(mainPanelLocation.getX(), mainPanelLocation.getY(), getBackgroundPanel().getMainWidth(),
		    getBackgroundPanel().getMainHeight());
	}
